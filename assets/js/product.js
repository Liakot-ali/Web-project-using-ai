document.addEventListener('DOMContentLoaded', () => {
  ...
  const catalog = {
    Office: [
      ...
      { name: 'Compact Console Table', price: '2900', length: '90 cm', width: '30 cm', height: '75 cm', image: 'https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?q=80&w=800&auto=format&fit=crop' },
      { name: 'Manager Desk with Drawers', price: '11500', length: '150 cm', width: '70 cm', height: '76 cm', image: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?q=80&w=800&auto=format&fit=crop' }
    ],
    Study: [
      ...
      { name: 'Floating Wall Desk', price: '3500', length: '90 cm', width: '40 cm', height: '70 cm', image: 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?q=80&w=800&auto=format&fit=crop' },
      { name: 'Study Desk with Shelves', price: '4800', length: '110 cm', width: '55 cm', height: '72 cm', image: 'https://images.unsplash.com/photo-1524758631624-3f1f1e6a6b6b?q=80&w=800&auto=format&fit=crop' },
      { name: 'Kids Study Table', price: '2600', length: '80 cm', width: '45 cm', height: '65 cm', image: 'https://images.unsplash.com/photo-1533777324565-a040eb52fac2?q=80&w=800&auto=format&fit=crop' }
    ],
    Gaming: [
      ...
      { name: 'L-Shaped Gaming Desk', price: '13500', length: '200 cm', width: '150 cm', height: '76 cm', image: 'https://images.unsplash.com/photo-1585386959984-a4155222e6f6?q=80&w=800&auto=format&fit=crop' },
      { name: 'Mobile Gaming Stand', price: '4200', length: '100 cm', width: '55 cm', height: '75 cm', image: 'https://images.unsplash.com/photo-1527430253228-e93688616381?q=80&w=800&auto=format&fit=crop' }
    ]
  };
